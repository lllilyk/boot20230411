...
public class Controller17 {
	...
	public void method01(int id, String name) throws Exception {
		String sql = """
				UPDATE Suppliers
				SET 
					SupplierName = ?
	...
	// /sub17/link2?id=39&address=seoul
	// supplierId가 39번인 공급자 주소(address)를 seoul로 바꾸는 메소드
	@RequestMapping("link2")
	public void method02(int id, String address) throws Exception{
		String sql = """
				UPDATE Suppliers
				SET 
					Address = ?
	...
	//supplierId가 39번인 공급자 주소(address)를 '아키타'로 바꾸는 메소드
	@RequestMapping("link22")
	public void method22(String address, int id) throws Exception{
		String sql = """
				UPDATE Suppliers
				SET	
						Address = ?
		...
		try(con; pstmt;){
			...
			System.out.println(count + "개 행 수정되었음");
		}
	}
